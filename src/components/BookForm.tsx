...
import type { Book, CreateBook, BookMeta, MetadataSuggestion } from "../types/book";
...
export function BookForm({ book, onClose }: Props) {
  ...
  const adoptCategory = (v: string) => set("category", v);
  const adoptRegion = (v: string) => set("region", v);
