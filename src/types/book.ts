...
export const REGIONS = [
  ...
  "爱尔兰", "以色列", "土耳其", "埃及", "南非", "尼日利亚", "白俄罗斯",
  "新西兰", "新加坡", "泰国", "越南", "缅甸", "巴基斯坦",
] as const;
export const CATEGORIES = ["小说", "文学", "散文", "诗歌", "历史", "古籍", "哲学", "宗教", "心理", "社科", "政治", "经济", "市场", "管理", "自然科学", "数学", "物理", "计算机", "医学", "科普", "建筑", "传记", "艺术", "设计", "音乐", "漫画", "语言", "生活", "军事", "其他"] as const;
